...
(function() {
  ...
  davis_app = Davis(function() {
    ...
    this.get('/#/itinerary/:itinerary/connection/:connection_id', function(req) {
      if (itinerary_loaded) {
    ...
    return this.get('/#/itinerary_url/:itinerary_url/connection/:connection_id', function(req) {
      if (itinerary_loaded) {
        current_connection = parseInt(req.params['connection_id']);
        return displayConnection(itinerary_connections[current_connection]);
      } else {
  ...
  connectionURL = function(connection_id) {
    if (itinerary_url) {
      return "/#/itinerary_url/" + (encodeURIComponent(itinerary_url)) + "/connection/" + connection_id;
    } else {
      return "/#/itinerary/" + (itinerary_places.join()) + "/connection/" + connection_id;
    }
  };
